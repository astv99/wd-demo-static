import{Q as r}from"./QuickActionButton-DuAM0TFG.js";import"./iframe-5H8Udzkd.js";import"./preload-helper-PPVm8Dsz.js";import"./misc-Dv5UcT8H.js";const i={title:"Action",description:"Resource",color:"#000000",icon:"",link:""},p={component:r,title:"QuickActionButton",tags:["autodocs"],excludeStories:/.*Data$/,args:{}},e={args:{...i}},o={args:{title:"Login",description:"Account",color:"#993F2B",icon:"../../assets/qa-icon-login.svg",link:"/login"}},s={args:{title:"Download",description:"Software",color:"#5637A9",icon:"../../assets/qa-icon-software.svg",link:"/software"}},t={args:{title:"Submit",description:"Requests",color:"#E2A543",icon:"../../assets/qa-icon-requests.svg",link:"/requests"}},n={args:{title:"Reserve",description:"Equipment",color:"#52793D",icon:"../../assets/qa-icon-equipment.svg",link:"/equipment"}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...n.parameters?.docs?.source}}};const m=["Default","Login","Software","Requests","Equipment"];export{e as Default,n as Equipment,o as Login,t as Requests,s as Software,m as __namedExportsOrder,p as default};
