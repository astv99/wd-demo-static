import{Q as r}from"./QuickActionButton-B6NGRJ5c.js";import"./iframe-LgiCmlYP.js";import"./preload-helper-PPVm8Dsz.js";const i={title:"Action",description:"Resource",color:"#000000",icon:"",link:""},l={component:r,title:"QuickActionButton",tags:["autodocs"],excludeStories:/.*Data$/,args:{}},e={args:{...i}},o={args:{title:"Login",description:"Account",color:"#993F2B",icon:"assets/qa-icon-login.svg",link:"/login"}},s={args:{title:"Download",description:"Software",color:"#5637A9",icon:"assets/qa-icon-software.svg",link:"/software"}},t={args:{title:"Submit",description:"Requests",color:"#E2A543",icon:"assets/qa-icon-requests.svg",link:"/requests"}},n={args:{title:"Reserve",description:"Equipment",color:"#52793D",icon:"assets/qa-icon-equipment.svg",link:"/equipment"}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
