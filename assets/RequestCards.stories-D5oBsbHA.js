import{d as A,o as t,f as n,g as s,t as r,k as i,X as P,Y as E,l as x,z as D,p as S,n as q,H as F,s as k,m as v}from"./iframe-CYZWmCxV.js";import{g as N}from"./helpers-SDxu2LFN.js";import{i as w}from"./webductorTypes-4RQzqXDp.js";import"./preload-helper-PPVm8Dsz.js";const U={class:"req-info"},O={class:"description"},B={key:0,class:"details-line"},j={key:0,class:"details-title"},$={class:"label"},M={key:1,class:"details"},z={key:1,class:"details-line"},f=A({__name:"RequestDetails",props:{description:{},details:{},examples:{}},setup(a){const d=c=>c?c.length>0:!1;return(c,e)=>(t(),n("div",U,[s("div",O,r(a.description),1),a.details&&a.details.length>0?(t(),n("hr",B)):i("",!0),(t(!0),n(P,null,E(a.details,(o,l)=>(t(),n("div",{key:l,class:"detail-item"},[o&&d(o.content)?(t(),n("p",j,[x(D,{icon:o?.icon,class:"detail-icon"},null,8,["icon"]),s("span",$,r(o?.label)+":",1)])):i("",!0),o&&d(o.content)?(t(),n("p",M,r(o?.content),1)):i("",!0)]))),128)),a.examples&&a.examples.length>0?(t(),n("hr",z)):i("",!0),e[0]||(e[0]=s("p",{class:"examples"},[s("span",{class:"label"},"Examples:")],-1)),(t(!0),n(P,null,E(a.examples,(o,l)=>(t(),n("div",{key:l,class:"example"},r(o),1))),128))]))}}),Q=S(f,[["__scopeId","data-v-fb6bff6f"]]);f.__docgenInfo=Object.assign({displayName:f.name??f.__name},{exportName:"default",displayName:"RequestDetails",description:"",tags:{},props:[{name:"description",required:!1,type:{name:"string"}},{name:"details",required:!1,type:{name:"Array",elements:[{name:`{
  label?: string;
  content?: string;
  icon?: string;
}`}]}},{name:"examples",required:!1,type:{name:"Array",elements:[{name:"string"}]}}],sourceFiles:["/workspaces/Conductor/Conductor.Web/src/components/requests/RequestDetails.vue"]});const L={class:"details-title"},V={class:"label"},G={class:"label-for"},R=A({__name:"StatusDetails",props:{statuses:{}},setup(a){return(d,c)=>(t(!0),n(P,null,E(a.statuses,(e,o)=>(t(),n("p",L,[s("span",V,r(e?.label)+":",1),s("span",G,r(e?.content),1)]))),256))}}),W=S(R,[["__scopeId","data-v-b6eb5f83"]]);R.__docgenInfo=Object.assign({displayName:R.name??R.__name},{exportName:"default",displayName:"StatusDetails",description:"",tags:{},props:[{name:"statuses",required:!1,type:{name:"Array",elements:[{name:`{
  label?: string;
  content?: string;
  icon?: string;
}`}]}}],sourceFiles:["/workspaces/Conductor/Conductor.Web/src/components/requests/StatusDetails.vue"]});const Y={class:"top"},H={key:0,class:"status-id"},K={class:"icon-outer"},X={class:"icon"},J={class:"type"},Z={class:"title"},h=A({__name:"RequestCards",props:{card:{default:()=>({statusId:"",type:"",typeColor:"",status:"",title:"",details:[],image:""})}},setup(a){const d=v(()=>e.card.type.replace(/_/g," ")),c=v(()=>N(e.card.typeColor)),e=a;return(o,l)=>(t(),n("div",{class:"bottom-layer",style:q({"--after-bg":e.card.typeColor||"#000000"})},[s("div",{class:"outer",style:q({"--card-bg":`url('${e.card.image}')`,"--overlay-color":"rgba(80, 80, 80, 0.28)","--hover-overlay-color":c.value})},[s("div",Y,[e.card.statusId?(t(),n("div",H,r(e.card.statusId),1)):i("",!0),s("div",K,[s("p",X,[x(D,{icon:e.card.typeIcon,class:"type-icon",style:q({backgroundColor:e.card.typeColor})},null,8,["icon","style"])])]),s("div",J,r(d.value),1),e.card.status?(t(),n("div",{key:1,class:F(["req-status",e.card.statusClass])},r(e.card.status),3)):i("",!0)]),s("div",Z,r(e.card.title),1),l[0]||(l[0]=s("hr",{class:"title-line"},null,-1)),e.card.details&&e.card.details.length>0&&!e.card.description?(t(),k(W,{key:0,statuses:e.card.details,class:"status-info"},null,8,["statuses"])):e.card.details&&e.card.details.length>0||e.card.examples&&e.card.examples.length>0||e.card.description?(t(),k(Q,{key:1,description:e.card.description,details:e.card.details,examples:e.card.examples,class:"req-info"},null,8,["description","details","examples"])):i("",!0)],4)],4))}}),ee=S(h,[["__scopeId","data-v-478214fe"]]);h.__docgenInfo=Object.assign({displayName:h.name??h.__name},{exportName:"default",displayName:"RequestCards",description:"",tags:{},props:[{name:"card",description:"Content of the card",required:!0,type:{name:"CardInfo"},defaultValue:{func:!1,value:`() => ({
  statusId: "",
  type: "",
  typeColor: "",
  status: "",
