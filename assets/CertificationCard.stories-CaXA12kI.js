import{d as C,o as f,f as g,g as e,p,t as s,y as D,A as _,q as d,s as v}from"./iframe-DggbHyIc.js";import{g as E}from"./helpers-SDxu2LFN.js";import"./preload-helper-PPVm8Dsz.js";const A={class:"top"},x={class:"type-outer"},S={class:"type"},T={class:"cert-status"},I={class:"title"},b={class:"cert-block"},h={class:"details"},k={class:"details-title"},q={class:"details-title"},l=C({__name:"CertificationCard",props:{card:{default:()=>({type:"",typeColor:"",status:"",title:"",issueDate:"",expiryDate:"",image:""})}},setup(u){const y=d(()=>t.card.type.replace(/_/g," ")),m=d(()=>E(t.card.typeColor)),t=u;return(N,a)=>(f(),g("div",{class:"bottom-layer",style:p({"--after-bg":t.card.typeColor||"#000000"})},[e("div",{class:"outer",style:p({"--card-bg":`url('${t.card.image}')`,"--overlay-color":"rgba(0, 0, 0, 0.28)","--hover-overlay-color":m.value})},[e("div",A,[e("div",x,[e("div",{class:"stub",style:p({backgroundColor:t.card.typeColor})},null,4),e("div",S,s(y.value),1)]),e("div",T,s(t.card.status),1)]),e("div",I,s(t.card.title),1),a[2]||(a[2]=e("hr",{class:"title-line"},null,-1)),e("div",b,[D(_,{icon:"mdi-certificate-outline",class:"cert-icon"})]),e("div",h,[e("p",k,[a[0]||(a[0]=e("span",{class:"label"},"Issued: ",-1)),e("span",null,s(t.card.issueDate),1)]),e("p",q,[a[1]||(a[1]=e("span",{class:"label"},"Expires: ",-1)),e("span",null,s(t.card.expiryDate),1)])])],4)],4))}}),B=v(l,[["__scopeId","data-v-b5f1d93a"]]);l.__docgenInfo=Object.assign({displayName:l.name??l.__name},{exportName:"default",displayName:"CertificationCard",description:"",tags:{},props:[{name:"card",description:"Content of the card",required:!0,type:{name:"CardInfo"},defaultValue:{func:!1,value:`() => ({
  type: "",
  typeColor: "",
  status: "",
  title: "",
