import{N as t,L as u}from"./iframe-YRFixpAM.js";import"./preload-helper-PPVm8Dsz.js";const d={component:t,argTypes:{menuItems:{control:"object",description:"Array of navigation items. Edit as JSON (e.g. [{ title: 'Home', to: '/' }])."},showStaff:{control:"boolean",description:"Whether to show items in the staffMenuItems array. When false, the staff bar is hidden."},roles:{control:"object",description:"Array of user roles to evaluate menu item visibility."}},parameters:{controls:{include:["showStaff","roles"]},docs:{description:{component:`The NavigationBar component provides standard and staff-specific menus.
