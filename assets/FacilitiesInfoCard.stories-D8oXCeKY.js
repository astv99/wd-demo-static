import{d as l,e as d,w as n,n as p,o as u,f as m,g as o,t as i}from"./iframe-C9Iv9W0s.js";import{V as g,a as f}from"./VCard-D_z03ZrL.js";import{_}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-PPVm8Dsz.js";const b={class:"stat-value text-white font-weight-bold"},y={class:"text-body-1 text-center text-white mt-3"},s=l({__name:"FacilitiesInfoCard",props:{stat:{default:""},byline:{default:""},image:{default:""}},setup(c){const r=c;return(I,x)=>(u(),d(g,{style:p({backgroundImage:`
        linear-gradient(
          180deg, 
          rgba(0, 0, 0, 0) 0%, 
