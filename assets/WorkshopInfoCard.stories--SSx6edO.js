import{d as u,o as f,f as g,g as o,p as d,i as v,t as a,h as i,q as C,s as y}from"./iframe-LgiCmlYP.js";import{g as T}from"./misc-ClPnoM_H.js";import{g as I}from"./helpers-SDxu2LFN.js";import"./preload-helper-PPVm8Dsz.js";import"./webductorTypes-DbEAYrnH.js";const E={class:"top"},_={class:"spots-left"},M={class:"title"},c=u({__name:"WorkshopInfoCard",props:{card:{default:()=>({typeColor:"",level:"DEFAULT",spotsleft:0,title:"",date:"",time:"",location:"",image:""})}},setup(p){const m=C(()=>I(e.card.typeColor)),e=p;return(D,t)=>(f(),g("div",{class:"bottom-layer",style:d({"--after-bg":e.card.typeColor||"#000000"})},[o("div",{class:"outer",style:d({"--card-bg":e.card.image?`url(${e.card.image})`:"none","--overlay-color":"rgba(0, 0, 0, 0.28)","--hover-overlay-color":m.value})},[o("div",E,[o("div",{class:"level",style:d({backgroundColor:v(T)(e.card.level),color:e.card.level==="INTERMEDIATE"?"#000000":"#ffffff"})},a(e.card.level),5),o("div",_,a(e.card.spotsleft)+" "+a(e.card.spotsleft>=2?"spots":"spot")+" left ",1)]),o("div",M,a(e.card.title),1),t[3]||(t[3]=o("hr",null,null,-1)),o("p",null,[t[0]||(t[0]=o("span",{class:"label"},"Date:",-1)),i(" "+a(e.card.date),1)]),o("p",null,[t[1]||(t[1]=o("span",{class:"label"},"Time:",-1)),i(" "+a(e.card.time),1)]),o("p",null,[t[2]||(t[2]=o("span",{class:"label"},"Location:",-1)),i(" "+a(e.card.location),1)])],4)],4))}}),A=y(c,[["__scopeId","data-v-1480aadc"]]);c.__docgenInfo=Object.assign({displayName:c.name??c.__name},{exportName:"default",displayName:"WorkshopInfoCard",description:"",tags:{},props:[{name:"card",description:"Composition of the button",required:!0,type:{name:"CardInfo"},defaultValue:{func:!1,value:`() => ({
  typeColor: "",
