import{d as m,h as c,g as a,t as o,n as g,o as l}from"./iframe-C9Iv9W0s.js";import{_ as f}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-PPVm8Dsz.js";const b={class:"bottom-layer"},_={class:"top"},I={class:"app"},h=["src","alt"],C={key:1},w={class:"description"},S={class:"details"},k={class:"details-title"},v={class:"details-title"},M={class:"details-title"},L={class:"details-title"},p=m({__name:"SoftwareCard",props:{card:{default:()=>({app:"",description:"",accessMethod:"",platforms:"",requirements:"",support:"",logoImage:"",backgroundImage:""})}},setup(u){const e=u;return(D,s)=>(l(),c("div",b,[a("div",{class:"outer",style:g({"--card-bg":`url('${e.card.backgroundImage}')`})},[a("div",_,[a("div",I,[e.card.logoImage?(l(),c("img",{key:0,class:"app-logo",src:e.card.logoImage,alt:`${e.card.app} logo`},null,8,h)):(l(),c("span",C,o(e.card.app+" logo"),1))])]),a("div",w,o(e.card.description),1),s[4]||(s[4]=a("hr",{class:"title-line"},null,-1)),a("div",S,[a("p",k,[s[0]||(s[0]=a("span",{class:"label"},"Access Method: ",-1)),a("span",null,o(e.card.accessMethod),1)]),a("p",v,[s[1]||(s[1]=a("span",{class:"label"},"Platforms: ",-1)),a("span",null,o(e.card.platforms),1)]),a("p",M,[s[2]||(s[2]=a("span",{class:"label"},"Requirements: ",-1)),a("span",null,o(e.card.requirements),1)]),a("p",L,[s[3]||(s[3]=a("span",{class:"label"},"Support: ",-1)),a("span",null,o(e.card.support),1)])])],4)]))}}),q=f(p,[["__scopeId","data-v-2d110ca6"]]);p.__docgenInfo=Object.assign({displayName:p.name??p.__name},{exportName:"default",displayName:"SoftwareCard",description:"",tags:{},props:[{name:"card",description:"Content of the card",required:!0,type:{name:"CardInfo"},defaultValue:{func:!1,value:`() => ({
  app: "",
  description: "",
  accessMethod: "",
  platforms: "",
